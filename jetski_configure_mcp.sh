...
# Default Jetski MCP configuration path (can be overridden by second argument)
CONFIG_FILE="${2:-$HOME/.gemini/jetski/mcp_config.json}"

if [ ! -f "$CONFIG_FILE" ]; then
  echo "Jetski MCP configuration file not found at $CONFIG_FILE. It will be created."
...
echo "Merging '$INPUT_JSON' into Jetski MCP configuration at $CONFIG_FILE..."
